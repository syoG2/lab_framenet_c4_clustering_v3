...
from util import convert_results_to_labels, extract_entities, id2label, label2id, preprocess_data, run_prediction
...
def main():
    ...
    df = df[["target_word", "preprocessed_text", "preprocessed_target_widx", "target_word_idx"]]
    # データのシャッフル
